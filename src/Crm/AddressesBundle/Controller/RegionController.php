...
use Crm\AddressesBundle\Form\Type\RegionType;

class RegionController extends AdminInterfaceController
{
    /**
     * @param string $class
     */
    ...
    {
        parent::__construct('Crm\AddressesBundle\Entity\Region','r');
    }
    ...
    public function indexAction()
    {
        ...
        return $this->render('CrmAddressesBundle:Region:list.html.twig', array(
            'results'     => $pagination,
            'items'       => $items,
    ...
    public function buildListFields()
    {
        ...
        $this->addInList(array(
            ...
            null,
            null,
            array('link_id' => 'crm_addresses_region_edit','style' => 'text-align:center')
        ))
        ;
    }
    ...
    public function editAction( Request $request, $id )
    {
        ...
        if( !$object)
        {
            throw new NotFoundHttpException('Адм. район не знайдено!');
        }
        
        $form = $this->createForm(new RegionType($object), $object, array(
                'action' => $this->generateUrl('crm_addresses_region_edit',array(
                    'id' => $object->getId()
                )),
        ));
        ...
        if ($form->isValid())
        {
            ...
            return $this->redirect( $this->generateUrl( 'crm_addresses_region_edit',array(
                'id' => $object->getId()
            )));
        }
        
        return $this->render('CrmAddressesBundle:Region:edit.html.twig', array(
    ...
    public function newAction( Request $request, $id)
    {
        ...
        $form = $this->createForm( new RegionType($object), $object);
    ...
    public function deleteAction( Request $request, $id )
    {
        ...
        else
        {
            ...
            if( $object )
            {
                ...
                StaticFunctions::writeLog(
                    $this->get('kernel')->getRootDir().'/logs/deleteRegionAction.log',
                    array($log)
                );
        ...
        return $this->redirect( $this->generateUrl( 'crm_addresses_region_list'));
    }
}
