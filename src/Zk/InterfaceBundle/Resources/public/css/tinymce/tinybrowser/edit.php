...
<?php
if($passfeid == '' && $tinybrowser['integration']=='tinymce') { printf('<link rel="stylesheet" type="text/css" media="all" href="%s" />',$tinybrowser['tinymcecss']); }
else { printf('<link rel="stylesheet" type="text/css" media="all" href="css/stylefull_tinybrowser.css" />'); }
?>
