...
$tinybrowser['path']['image'] = '/uploads/contents/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/contents/'; // Media files location
$tinybrowser['path']['file'] = '/uploads/contents/'; // Other files location
...
$tinybrowser['tinymcecss'] = 'css/dialog.css';
